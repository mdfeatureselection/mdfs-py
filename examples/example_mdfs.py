...
def run_example_mdfs(dimensions):
    return mdfs.run(data, decision, dimensions=dimensions, seed=0, discretizations=30, n_contrast=30)


for dimensions in [1, 2]:
    result = run_example_mdfs(dimensions=dimensions)
